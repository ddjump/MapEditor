    ...
    public void handleNewRequest() {
        ...
        try {
            ...
            if (continueToMakeNew) {
                ...
                NewMapDialog nm = new NewMapDialog(app);
                nm.playDialog();
                newFile = nm.getSelectedFile();

                if (newFile != null) {
                    try {
                        AppDataComponent dataManager = app.getDataComponent();
                        AppFileComponent fileManager = app.getFileComponent();
                        fileManager.importData(dataManager, newFile.getPath(), nm.getRegion(), nm.getParentRegion());
