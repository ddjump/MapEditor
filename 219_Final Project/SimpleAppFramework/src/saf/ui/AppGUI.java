...
public class AppGUI implements AppStyleArbiter {
    ...
    private void initFileToolbar(AppTemplate app) {
        ...
        fileToolbarPane.setHgap(10.0);

        // HERE ARE OUR FILE TOOLBAR BUTTONS, NOTE THAT SOME WILL
        // START AS ENABLED (false), WHILE OTHERS DISABLED (true)
        newButton = initChildButton(fileToolbarPane,    ADD_MAP.toString(),	    NEW_TOOLTIP.toString(),	false);
        ...
        exportButton = initChildButton(fileToolbarPane,	EXPORTING_ICON.toString(),	    EXPORT_TOOLTIP.toString(),	false);
        exitButton = initChildButton(fileToolbarPane,	EXIT_ICON.toString(),	    EXIT_TOOLTIP.toString(),	false);
        //fileToolbarPane.getChildren().add(new Label("               "));
	...
	// NOW MAKE THE BUTTON
        ...
        button.setMaxHeight(Double.SIZE);
        button.setMaxWidth(Double.SIZE);
